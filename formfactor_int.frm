...
if (expression(coli3) && (match(T1(cOli1?) * cOlf(c3, cOli2?, cOli3?) * cOlf(c4, cOli2?, cOli4?) * cOlf(cOli1?, cOli3? cOli4?)) == 0)) discard;
.sort
...
bracket  T1, T2, cOlf, Int, lam, ep, [d-4], [d-2], [d-1];
print[] coli1, coli2, coli3; 
.sort 
id T1(cOli1?) = 1; 
id T2(cOli2?) = 1; 
...
#optimize coli1
#write <results/formfac1.txt> "%O"
#write <results/formfac1.txt> "std::complex<double> coli1terms = %e", coli1
.sort

#optimize coli2
#write <results/formfac2.txt> "%O"
#write <results/formfac2.txt> "std::complex<double> coli2terms = %e", coli2
.sort

#optimize coli3
#write <results/formfac3.txt> "%O"
#write <results/formfac3.txt> "std::complex<double> coli3terms = %e", coli3
.sort
